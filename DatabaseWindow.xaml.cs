...
namespace TTS_Chan
{
    ...
    public partial class DatabaseWindow
    {
        public DatabaseWindow()
        {
            ...
            DatabaseManager.Context.MessageSubstitutions.Load();
            SubstitutionsGrid.DataContext = DatabaseManager.Context.MessageSubstitutions.Local.ToObservableCollection();
        }

        private void UserDataGridEdit(object sender, RoutedEventArgs e)
        {
            var selected = (UserVoice) UsersGrid.SelectedValue;
            var voiceWindow = new UserVoiceWindow(selected);
        ...
        {
            DatabaseManager.Context.MessageSubstitutions.Add(new MessageSubstitution
            {
                Comment = "Remove messages starting with !",
                IsRegex = true,
                Pattern = "^!.*",
                Replacement = ""
            });
            ...
            DatabaseManager.Context.MessageSubstitutions.Add(new MessageSubstitution
            {
                Comment = "Remove numbers longer than 4 digits",
                IsRegex = true,
                Pattern = @"\d{4,}",
                Replacement = ""
            });
            ...
            DatabaseManager.Context.MessageSubstitutions.Add(new MessageSubstitution
            {
                Comment = "Pex is always cute",
                IsRegex = false,
                Pattern = @"Pex_is_watching",
                Replacement = "Pex_is_cute"
            });
            DatabaseManager.Context.MessageSubstitutions.Add(new MessageSubstitution
            {
                Comment = "Streamer is not %insult%",
                IsRegex = true,
                Pattern = @"streamer is (\w+)",
                Replacement = "streamer is NOT $1"
            });
            DatabaseManager.Context.SaveChanges();
        }
